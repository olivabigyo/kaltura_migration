...
$string['replaceallmodulestask'] = 'Replace all activities (background task)';
...
$string['modulestolti'] = 'Replace each SwitchCast module by a Kaltura Activity external tool';
